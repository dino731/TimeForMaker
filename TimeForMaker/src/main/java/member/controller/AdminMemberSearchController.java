...
public class AdminMemberSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//--------------- 페이징 처리 -----------------------
				...
				String inputMemberSeach = request.getParameter("inputMemberSeach");
				
				ArrayList<Member> list = new AdminMemberService().searchMemberList(inputMemberSeach,pi);
