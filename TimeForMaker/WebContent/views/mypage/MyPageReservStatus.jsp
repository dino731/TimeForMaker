			...
			<div class="mypage-appointment-list-wrapper">
				<div class="mypage-appointment-list-container">
					...
					<div class="mypage-appointment-list">
						<div class="mypage-appointment-list-img" onclick="location.href='<%=contextPath%>/detail.product?pno=<%=mreserv.get(i).getProductNo()%>'" >
							<img src="<%=contextPath %><%= mreserv.get(i).getFileSavePath() %><%= mreserv.get(i).getFileName()%>">
						</div>
						<div class="mypage-appointment-text-container">
							<span class="mypage-appointment-list-title" onclick="location.href='<%=contextPath%>/detail.product?pno=<%=mreserv.get(i).getProductNo()%>'"><%= mreserv.get(i).getClassName() %></span>
							<br>
							...
							<script>
								 <% if(mreserv.get(i).getPaymentStatus().equals("결제대기")) { %>
								 	document.write('<span class="mypage-reserv-status" style="color: green;"><%= mreserv.get(i).getPaymentStatus() %></span>');
									<%}else{ %>
										document.write('<span class="mypage-reserv-status" style="color: green;"><%= mreserv.get(i).getReservationStatus() %></span>');
	                                <%} %>
	                        </script>        
							<br> 
							...
							<script>
						        <% if(mreserv.get(i).getPaymentStatus().equals("결제대기")) { %>
						            document.write('<button class="mypage-btn-payment" style="margin:3px 3px 3px 150px;" onclick="mypage_payment();">결제</button>');
						        <% } else { %>
						            document.write('<button class="mypage-btn-cancel" style="margin:3px 3px 3px 150px;" onclick="mypage_delete();">예약취소</button>');
						        <% } %>
						    </script>
					</div>
