...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<%
	ArrayList<Product> mplolist = (ArrayList<Product>)request.getAttribute("mplolist");
...
<body>
	...
	<div class="container py-5 pl_class_all">
		<div class="row">
		<div>
			<img style="width: 100%; height: 300px; align-content: center;" class="img-fluid" src="/TimeForMaker/assets/img/locaBanner.jpg" alt="">
		</div>
			<h1 class="h2 pl_class_all_title">지역별 클래스</h1>
			<div class="col-12 mb-3">
				<div class="w-100 my-3 border-top border"></div>
			</div>

			<div class="pl_class_card_wrap">
			<%for(Product p : mplolist) {
				 if (p.getFileLevel()==1) {
			%>
				<!--클래스 카드 전체부분-->
